...
export const loadMostOrderedMeal = () => dispatch => fetch('/api/v1/mostOrder/meals/6')
  .then(res => res.json())
  .then(mostOrder =>
    dispatch(loadMostOrdered(mostOrder)));

export const getAllMeals = () => dispatch => fetch('/api/v1/meals', {
  headers: {
...
export const createMeal = payload => dispatch => fetch('/api/v1/meals', {
  method: 'POST',
  headers: {
    authorization: auth.getToken()
  },
...
export const deleteMeal = id => dispatch => fetch(`/api/v1/meals/${id}`, {
  method: 'DELETE',
  headers: {
    authorization: auth.getToken()
  }
...
export const updateMeal = (id, payload) => dispatch => fetch(`/api/v1/meals/${id}`, {
  method: 'PUT',
  headers: {
    authorization: auth.getToken()
  },
